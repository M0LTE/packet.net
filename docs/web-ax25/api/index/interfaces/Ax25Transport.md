...
[@packet-net/ax25](../../README.md) / [index](../README.md) / Ax25Transport

# Interface: Ax25Transport

Defined in: [transport.ts:14](https://github.com/M0LTE/packet.net/blob/main/web/ax25/src/transport.ts#L14)
...
Defined in: [transport.ts:23](https://github.com/M0LTE/packet.net/blob/main/web/ax25/src/transport.ts#L23)
...
Defined in: [transport.ts:20](https://github.com/M0LTE/packet.net/blob/main/web/ax25/src/transport.ts#L20)
...
Defined in: [transport.ts:26](https://github.com/M0LTE/packet.net/blob/main/web/ax25/src/transport.ts#L26)
