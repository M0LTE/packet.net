...
### 2026-06-03 — simultaneous-bidirectional SREJ recovery: fix figc4.5 Timer-Recovery V(R) drain decrement (R1, ax25sdl#49); characterize the ring-wrap selective-replay reference (R2)
