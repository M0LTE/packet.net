...
**Slice-1 follow-on — AXUDP transport + slow-channel defaults ✅ (PR #PRNUM; see [§17](#17-amendment-log)).** Two additions on the slice-1 seams:
...
### 2026-06-04 — Node AXUDP transport + a named opt-in slow-channel profile (PR #PRNUM)
