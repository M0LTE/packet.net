...
| 5.Z V2 ⬜ | SABME (mod-128) connect vs **direwolf** over net-sim AFSK1200 | as above vs direwolf (figure-faithful oracle; its source documents the SABME handshake). **Needs direwolf in the stack — #177.** |
