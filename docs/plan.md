...
**Latest amendment:** [§17 entry 2026-06-07 — Give the `slow-afsk1200` profile a TXTAIL=5 (50 ms): AFSK1200 is the software-modem channel (direwolf/samoyed/soundcard) and a software modem clips its transmission without a TX tail (the net-sim lab's TxTail=0 decode-collapse); scoped to the profile, NOT a node-wide default, because a hardware TNC with an analogue audio path needs none (Tom) (PR TBD)](#17-amendment-log)
...
### 2026-06-07 — `slow-afsk1200` profile gains a software-modem TX tail (TXTAIL=5) (PR TBD)
