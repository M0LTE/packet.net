...
### 2026-06-07 — Telnet/relay line discipline: drop NUL so a CR-NUL "Enter" doesn't break the next command (PR TBD)
...
### 2026-06-06 — Persist the learned NET/ROM routing table to SQLite (`pdn.db`) so a restart isn't blind (PR TBD)
