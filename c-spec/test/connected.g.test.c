...
static int test_t02_i_received_not_command(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t02_i_received_not_command") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t03_i_received_command_info_field_invalid_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t03_i_received_command_info_field_invalid_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->guard, "command and not info_field_valid and version_2_2", "guard");
    ...
    ASSERT_STREQ(t->actions[2].verb, "clear_layer_3_initiated", "actions[2].verb");
...
static int test_t04_i_received_command_info_field_invalid_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t04_i_received_command_info_field_invalid_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->guard, "command and not info_field_valid and not version_2_2", "guard");
    ASSERT(t->actions_len == 3, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "DL_ERROR_indication_O", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SIGNAL_UPPER, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Establish_Data_Link", "actions[1].verb");
...
static int test_t05_i_received_command_info_valid_nr_out_of_window_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t05_i_received_command_info_valid_nr_out_of_window_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t05_i_received_command_info_valid_nr_out_of_window_v22 not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "AwaitingConnection22", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and not V_a_le_N_r_le_V_s and version_2_2", "guard");
...
static int test_t06_i_received_command_info_valid_nr_out_of_window_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t06_i_received_command_info_valid_nr_out_of_window_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t06_i_received_command_info_valid_nr_out_of_window_v20 not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "AwaitingConnection", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and not V_a_le_N_r_le_V_s and not version_2_2", "guard");
    ASSERT(t->actions_len == 1, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "N_r_Error_Recovery", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    return 0;
...
static int test_t07_i_received_own_busy_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t07_i_received_own_busy_p_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and own_receiver_busy and P_eq_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "discard_contents_of_I_frame", "actions[1].verb");
    ASSERT(t->actions[1].kind == AX25SDL_KIND_PROCESSING, "actions[1].kind");
    ...
    ASSERT_STREQ(t->actions[5].verb, "clear_acknowledge_pending", "actions[5].verb");
...
static int test_t08_i_received_own_busy_p_eq_0(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t08_i_received_own_busy_p_eq_0") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and own_receiver_busy and not P_eq_1", "guard");
    ASSERT(t->actions_len == 2, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "discard_contents_of_I_frame", "actions[1].verb");
...
static int test_t09_i_received_in_seq_no_stored_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t09_i_received_in_seq_no_stored_p_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and not V_r_I_frame_stored and P_eq_1", "guard");
    ...
    ASSERT(t->actions[2].kind == AX25SDL_KIND_PROCESSING, "actions[2].kind");
    ASSERT_STREQ(t->actions[3].verb, "decrement_srej_exception_if_gt_0", "actions[3].verb");
    ASSERT(t->actions[3].kind == AX25SDL_KIND_PROCESSING, "actions[3].kind");
    ...
    ASSERT_STREQ(t->actions[8].verb, "clear_acknowledge_pending", "actions[8].verb");
...
static int test_t10_i_received_in_seq_no_stored_p_eq_0_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t10_i_received_in_seq_no_stored_p_eq_0_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t10_i_received_in_seq_no_stored_p_eq_0_ack_pending not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and not V_r_I_frame_stored and not P_eq_1 and acknowledge_pending", "guard");
    ASSERT(t->actions_len == 5, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "V(r) := V(r) + 1", "actions[1].verb");
...
static int test_t11_i_received_in_seq_no_stored_p_eq_0_no_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t11_i_received_in_seq_no_stored_p_eq_0_no_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t11_i_received_in_seq_no_stored_p_eq_0_no_ack_pending not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and not V_r_I_frame_stored and not P_eq_1 and not acknowledge_pending", "guard");
    ...
    ASSERT_STREQ(t->actions[6].verb, "set_acknowledgement_pending", "actions[6].verb");
    ASSERT(t->actions[6].kind == AX25SDL_KIND_PROCESSING, "actions[6].kind");
    return 0;
}
...
static int test_t12_i_received_out_of_seq_reject_exception_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t12_i_received_out_of_seq_reject_exception_p_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t12_i_received_out_of_seq_reject_exception_p_eq_1 not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and reject_exception and P_eq_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "discard_contents_of_I_frame", "actions[1].verb");
...
static int test_t13_i_received_out_of_seq_reject_exception_p_eq_0(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t13_i_received_out_of_seq_reject_exception_p_eq_0") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t13_i_received_out_of_seq_reject_exception_p_eq_0 not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and reject_exception and not P_eq_1", "guard");
    ASSERT(t->actions_len == 2, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "discard_contents_of_I_frame", "actions[1].verb");
...
static int test_t14_i_received_out_of_seq_srej_enabled_no_excep_in_range(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t14_i_received_out_of_seq_srej_enabled_no_excep_in_range") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t14_i_received_out_of_seq_srej_enabled_no_excep_in_range not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and not reject_exception and srej_enabled and not srej_exception_gt_0 and not N_s_gt_V_r_plus_1", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "save_contents_of_I_frame", "actions[1].verb");
    ASSERT(t->actions[1].kind == AX25SDL_KIND_PROCESSING, "actions[1].kind");
    ASSERT_STREQ(t->actions[2].verb, "N(r) := V(r)", "actions[2].verb");
    ASSERT(t->actions[2].kind == AX25SDL_KIND_PROCESSING, "actions[2].kind");
    ASSERT_STREQ(t->actions[3].verb, "F := 1", "actions[3].verb");
    ASSERT(t->actions[3].kind == AX25SDL_KIND_PROCESSING, "actions[3].kind");
    ASSERT_STREQ(t->actions[4].verb, "increment_srej_exception", "actions[4].verb");
    ASSERT(t->actions[4].kind == AX25SDL_KIND_PROCESSING, "actions[4].kind");
...
static int test_t15_i_received_out_of_seq_srej_enabled_no_excep_far_skip(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t15_i_received_out_of_seq_srej_enabled_no_excep_far_skip") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t15_i_received_out_of_seq_srej_enabled_no_excep_far_skip not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and not reject_exception and srej_enabled and not srej_exception_gt_0 and N_s_gt_V_r_plus_1", "guard");
    ASSERT(t->actions_len == 8, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "save_contents_of_I_frame", "actions[1].verb");
    ASSERT(t->actions[1].kind == AX25SDL_KIND_PROCESSING, "actions[1].kind");
    ASSERT_STREQ(t->actions[2].verb, "discard_contents_of_I_frame", "actions[2].verb");
    ASSERT(t->actions[2].kind == AX25SDL_KIND_PROCESSING, "actions[2].kind");
    ...
    ASSERT_STREQ(t->actions[7].verb, "clear_acknowledge_pending", "actions[7].verb");
...
static int test_t16_i_received_out_of_seq_srej_enabled_existing_excep(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t16_i_received_out_of_seq_srej_enabled_existing_excep") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t16_i_received_out_of_seq_srej_enabled_existing_excep not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and not reject_exception and srej_enabled and srej_exception_gt_0", "guard");
    ASSERT(t->actions_len == 6, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "save_contents_of_I_frame", "actions[1].verb");
...
static int test_t17_i_received_out_of_seq_srej_disabled(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t17_i_received_out_of_seq_srej_disabled") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and not N_s_eq_V_r and not reject_exception and not srej_enabled", "guard");
    ASSERT(t->actions_len == 7, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "discard_contents_of_I_frame", "actions[1].verb");
    ...
    ASSERT(t->actions[5].kind == AX25SDL_KIND_SIGNAL_LOWER, "actions[5].kind");
    ASSERT_STREQ(t->actions[6].verb, "clear_acknowledge_pending", "actions[6].verb");
    ASSERT(t->actions[6].kind == AX25SDL_KIND_PROCESSING, "actions[6].kind");
    return 0;
}
...
static int test_t18_dl_data_request(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t18_dl_data_request") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t19_i_frame_pops_off_queue_send_now_t1_running(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t19_i_frame_pops_off_queue_send_now_t1_running") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "not peer_receiver_busy and not V_s_eq_V_a_plus_k and T1_running", "guard");
    ASSERT(t->actions_len == 6, "actions count");
...
static int test_t20_i_frame_pops_off_queue_send_now_t1_not_running(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t20_i_frame_pops_off_queue_send_now_t1_not_running") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t20_i_frame_pops_off_queue_send_now_t1_not_running not found");
    ASSERT_STREQ(t->on, "I_frame_pops_off_queue", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "not peer_receiver_busy and not V_s_eq_V_a_plus_k and not T1_running", "guard");
    ASSERT(t->actions_len == 8, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "N(s) := V(s)", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_PROCESSING, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "N(r) := V(r)", "actions[1].verb");
...
static int test_t21_i_frame_pops_off_queue_window_full(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t21_i_frame_pops_off_queue_window_full") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_frame_pops_off_queue", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "not peer_receiver_busy and V_s_eq_V_a_plus_k", "guard");
    ASSERT(t->actions_len == 1, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "push_on_I_frame_queue", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_INTERNAL_OUT, "actions[0].kind");
    return 0;
...
static int test_t22_i_frame_pops_off_queue_peer_busy(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t22_i_frame_pops_off_queue_peer_busy") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t23_dl_unit_data_request(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t23_dl_unit_data_request") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t24_dl_flow_off_when_not_busy(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t24_dl_flow_off_when_not_busy") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[2].verb, "clear_acknowledge_pending", "actions[2].verb");
    ASSERT(t->actions[2].kind == AX25SDL_KIND_PROCESSING, "actions[2].kind");
    return 0;
}
...
static int test_t25_dl_flow_off_when_already_busy(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t25_dl_flow_off_when_already_busy") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t26_dl_flow_on_when_busy_and_t1_not_running(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t26_dl_flow_on_when_busy_and_t1_not_running") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT(t->actions_len == 5, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "clear_own_receiver_busy", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_PROCESSING, "actions[0].kind");
...
static int test_t27_dl_flow_on_when_busy_and_t1_running(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t27_dl_flow_on_when_busy_and_t1_running") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t28_dl_flow_on_when_not_busy(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t28_dl_flow_on_when_not_busy") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t29_dl_connect_request_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t29_dl_connect_request_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t30_dl_connect_request_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t30_dl_connect_request_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t31_all_other_primitives_from_lower_layer(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t31_all_other_primitives_from_lower_layer") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t32_control_field_error_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t32_control_field_error_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t33_control_field_error_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t33_control_field_error_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t34_info_not_permitted_in_frame_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t34_info_not_permitted_in_frame_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t35_info_not_permitted_in_frame_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t35_info_not_permitted_in_frame_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t36_u_or_s_frame_length_error_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t36_u_or_s_frame_length_error_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t37_u_or_s_frame_length_error_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t37_u_or_s_frame_length_error_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t40_sabm_received_vs_neq_va(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t40_sabm_received_vs_neq_va") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT(t->actions[2].kind == AX25SDL_KIND_SIGNAL_LOWER, "actions[2].kind");
    ASSERT_STREQ(t->actions[3].verb, "Clear_Exception_Conditions", "actions[3].verb");
...
static int test_t41_sabm_received_vs_eq_va(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t41_sabm_received_vs_eq_va") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t42_sabme_received_vs_neq_va(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t42_sabme_received_vs_neq_va") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t43_sabme_received_vs_eq_va(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t43_sabme_received_vs_eq_va") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t44_frmr_received_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t44_frmr_received_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t45_frmr_received_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t45_frmr_received_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t46_ua_received_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t46_ua_received_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t47_ua_received_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t47_ua_received_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t48_ui_received_p_eq_0(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t48_ui_received_p_eq_0") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t49_ui_received_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t49_ui_received_p_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t50_disc_received(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t50_disc_received") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[2].verb, "UA", "actions[2].verb");
    ASSERT(t->actions[2].kind == AX25SDL_KIND_SIGNAL_LOWER, "actions[2].kind");
    ASSERT_STREQ(t->actions[3].verb, "DL_DISCONNECT_indication", "actions[3].verb");
...
static int test_t51_dm_received(void) {
    ...
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SIGNAL_UPPER, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "DL_DISCONNECT_indication", "actions[1].verb");
...
static int test_t52_rr_received_nr_in_window(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t52_rr_received_nr_in_window") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT(t->actions[0].kind == AX25SDL_KIND_PROCESSING, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "Check_Need_For_Response", "actions[1].verb");
    ASSERT(t->actions[1].kind == AX25SDL_KIND_SUBROUTINE, "actions[1].kind");
    ASSERT_STREQ(t->actions[2].verb, "Check_I_Frame_Acknowledged", "actions[2].verb");
    ASSERT(t->actions[2].kind == AX25SDL_KIND_SUBROUTINE, "actions[2].kind");
    return 0;
}
...
static int test_t53_rr_received_nr_out_of_window_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t53_rr_received_nr_out_of_window_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t54_rr_received_nr_out_of_window_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t54_rr_received_nr_out_of_window_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t55_rnr_received_nr_in_window(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t55_rnr_received_nr_in_window") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t56_rnr_received_nr_out_of_window_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t56_rnr_received_nr_out_of_window_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t57_rnr_received_nr_out_of_window_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t57_rnr_received_nr_out_of_window_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t58_lm_seize_confirm_no_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t58_lm_seize_confirm_no_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t59_lm_seize_confirm_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t59_lm_seize_confirm_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT(t->actions_len == 3, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "clear_acknowledge_pending", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_PROCESSING, "actions[0].kind");
...
static int test_t60_srej_received_nr_in_window_pf_eq_0(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t60_srej_received_nr_in_window_pf_eq_0") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[5].verb, "push_old_I_frame_N_r_on_queue", "actions[5].verb");
    ...
    ASSERT(t->actions[8].kind == AX25SDL_KIND_PROCESSING, "actions[8].kind");
    ASSERT_STREQ(t->actions[9].verb, "clear_acknowledge_pending", "actions[9].verb");
    ASSERT(t->actions[9].kind == AX25SDL_KIND_PROCESSING, "actions[9].kind");
    return 0;
}
...
static int test_t61_srej_received_nr_in_window_pf_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t61_srej_received_nr_in_window_pf_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->actions[6].verb, "push_old_I_frame_N_r_on_queue", "actions[6].verb");
    ...
    ASSERT(t->actions[9].kind == AX25SDL_KIND_PROCESSING, "actions[9].kind");
    ASSERT_STREQ(t->actions[10].verb, "clear_acknowledge_pending", "actions[10].verb");
    ASSERT(t->actions[10].kind == AX25SDL_KIND_PROCESSING, "actions[10].kind");
    return 0;
}
...
static int test_t62_srej_received_nr_out_of_window_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t62_srej_received_nr_out_of_window_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t63_srej_received_nr_out_of_window_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t63_srej_received_nr_out_of_window_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t64_rej_received_nr_in_window(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t64_rej_received_nr_in_window") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t65_rej_received_nr_out_of_window_v22(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t65_rej_received_nr_out_of_window_v22") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t66_rej_received_nr_out_of_window_v20(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t66_rej_received_nr_out_of_window_v20") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
...
static int test_t67_i_received_in_seq_stored_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t67_i_received_in_seq_stored_p_eq_1") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ...
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and V_r_I_frame_stored and P_eq_1", "guard");
    ...
    ASSERT_STREQ(t->actions[4].verb, "DL_DATA_indication", "actions[4].verb");
    ASSERT(t->actions[4].kind == AX25SDL_KIND_SIGNAL_UPPER, "actions[4].kind");
    ASSERT_STREQ(t->actions[5].verb, "retrieve_stored_V_r_I_frame", "actions[5].verb");
    ASSERT(t->actions[5].kind == AX25SDL_KIND_PROCESSING, "actions[5].kind");
    ...
    ASSERT_STREQ(t->actions[11].verb, "clear_acknowledge_pending", "actions[11].verb");
    ASSERT(t->actions[11].kind == AX25SDL_KIND_PROCESSING, "actions[11].kind");
    return 0;
}
...
static int test_t68_i_received_in_seq_stored_p_eq_0_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t68_i_received_in_seq_stored_p_eq_0_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t68_i_received_in_seq_stored_p_eq_0_ack_pending not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and V_r_I_frame_stored and not P_eq_1 and acknowledge_pending", "guard");
    ASSERT(t->actions_len == 8, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "V(r) := V(r) + 1", "actions[1].verb");
...
static int test_t69_i_received_in_seq_stored_p_eq_0_no_ack_pending(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_connected.transitions_len; i++) {
        if (strcmp(data_link_connected.transitions[i].id, "t69_i_received_in_seq_stored_p_eq_0_no_ack_pending") == 0) {
            t = &data_link_connected.transitions[i];
            break;
        }
    }
    ASSERT(t != NULL, "t69_i_received_in_seq_stored_p_eq_0_no_ack_pending not found");
    ASSERT_STREQ(t->on, "I_received", "on");
    ASSERT_STREQ(t->next, "Connected", "next");
    ASSERT_STREQ(t->guard, "command and info_field_valid and V_a_le_N_r_le_V_s and not own_receiver_busy and N_s_eq_V_r and V_r_I_frame_stored and not P_eq_1 and not acknowledge_pending", "guard");
    ASSERT(t->actions_len == 10, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "Check_I_Frame_Acknowledged", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SUBROUTINE, "actions[0].kind");
    ASSERT_STREQ(t->actions[1].verb, "V(r) := V(r) + 1", "actions[1].verb");
    ...
    ASSERT_STREQ(t->actions[9].verb, "set_acknowledgement_pending", "actions[9].verb");
    ASSERT(t->actions[9].kind == AX25SDL_KIND_PROCESSING, "actions[9].kind");
    return 0;
}
