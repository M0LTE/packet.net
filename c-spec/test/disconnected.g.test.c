...
static int test_t04_all_other_primitives_from_lower_layer(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t04_all_other_primitives_from_lower_layer") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t06_all_other_primitives_from_upper_layer(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t06_all_other_primitives_from_upper_layer") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t10_ua_received(void) {
    ...
    ASSERT_STREQ(t->next, "Disconnected", "next");
    ASSERT(t->actions_len == 1, "actions count");
    ASSERT_STREQ(t->actions[0].verb, "DL_ERROR_indication_C_D", "actions[0].verb");
    ASSERT(t->actions[0].kind == AX25SDL_KIND_SIGNAL_UPPER, "actions[0].kind");
    return 0;
}
...
static int test_t11_ui_received_p_eq_1(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t11_ui_received_p_eq_1") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t12_ui_received_p_eq_0(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t12_ui_received_p_eq_0") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t13_disc_received(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t13_disc_received") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t14_sabm_received_able(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t14_sabm_received_able") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t15_sabm_received_unable(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t15_sabm_received_unable") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t16_sabme_received_able(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t16_sabme_received_able") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
...
static int test_t17_sabme_received_unable(void) {
    const TransitionSpec* t = NULL;
    for (size_t i = 0; i < data_link_disconnected.transitions_len; i++) {
        if (strcmp(data_link_disconnected.transitions[i].id, "t17_sabme_received_unable") == 0) {
            t = &data_link_disconnected.transitions[i];
            break;
        }
    }
